import model.*;
import model.alocação.Desenvolvedor;
import model.alocação.Projeto;
...
public class App {
  public static void main(String[] args) {
    ...
    System.out.println(devNatalia.getProjetos().size() == 1);
    System.out.println(devPedro.getProjetos().size() == 1);
    System.out.println(devRogerio.getProjetos().size() == 1);
    System.out.println(projetoEdu.getDesenvolvedores().size() == 3);

    devNatalia.alocarNo(projetoEdu);
    devPedro.alocarNo(projetoEdu);
    System.out.println(projetoEdu.getDesenvolvedores().size() == 5);
    System.out.println(projetoEdu.hasDesenvolvedor(devArtur) == true);
    System.out.println(projetoEdu.hasDesenvolvedor(devRoberta) == true);
    System.out.println(projetoEdu.hasDesenvolvedor(devMarina) == true);
    System.out.println(projetoEdu.hasDesenvolvedor(devNatalia) == true);
    System.out.println(projetoEdu.hasDesenvolvedor(devPedro) == true);
