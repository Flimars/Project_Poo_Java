...
class App {
  public static void main(String[] args) {
    ...
    System.out.println("|------------------------------|");
    System.out.println("|---- Exercício  01 - Time ----|");
    System.out.println("|------------------------------|");
    ...
    Time tresHorasQuarentaMinutosQuatroSegundos =
    tresHorasQuarentaMinutosUmSegundo.tick().tick().tick();
    System.out.println(tresHorasQuarentaMinutosQuatroSegundos); // 03:40:04
    System.out.println(tresHorasQuarentaMinutosQuatroSegundos.toString().equals(
    "03:40:04"));

    Time quantoEuValho = tresHorasQuarentaMinutosQuatroSegundos.plusHours(50).plusMinutes(50).
    minusSeconds(50).tick().shift(); System.out.println(quantoEuValho); // quanto?
    System.out.println(quantoEuValho.toString().
    equals("18:29:15"));

    System.out.println("|---------------------------------------------|");
    System.out.println("|---- Exercício  02 - Rep. e Formato Time ----|");
    System.out.println("|---------------------------------------------|");
    ...
    System.out.println(dezesseisHorasQuarentaCincoMinOnzeSeg.toDouble() == 16.753055555555555); // faça o ajuste para o valor
                                                                                         // correto retornado
    System.out.println(Time.fromString("13:04:59").toDouble()); // 13.08305556 aproximadamente
    System.out.println(Time.fromString("13:04:59").toDouble() == 13.083055555555555); // faça o ajuste para o valor correto
                                                                               // retornado
    ...
    System.out.println("|---------------------------------------------|");
    System.out.println("|-------- Exercício  03 - Comprimento --------|");
    System.out.println("|---------------------------------------------|");
...
*/
    System.out.println("|---------------------------------------------|");
    System.out.println("|-------- Exercício  04 - Bater Ponto --------|");
    System.out.println("|---------------------------------------------|");
    ...
    System.out.println(pontoSpock); // Spock entrou às 07h50m15s e saiu às 12h02m10s e permaneceu 4 horas, 2 minutos
                                    // e 10 segundos
    System.out.println(pontoSpock.toString()
        .equals("Spock entrou às 07h50m15s e saiu às 12h02m10s e permaneceu 4 horas 11 minutos e 55 segundos"));//
    ...
    System.out
        .println(pontoKirk.toString().equals("Kirk entrou às 14h e saiu às 03h10m e permaneceu 13 horas e 10 minutos"));
