...
class App {
  ...
  public static void main(String[] args) {
    ...
    // Locação Residencial
    Residencial loc1 = new Residencial("Rua Alfredo Huch, 475", 2, 1, 900.0, 100.0);

    System.out.println(loc1.getTipo() == "Residencial"); // Residencial
    System.out.println(loc1.getEndereco() == "Rua Alfredo Huch, 475"); // Rua Alfredo Huch, 475
    ...
    System.out.println(loc2.getTipo() == "Apartamento"); // Apartamento
    System.out.println(loc2.getEndereco() == "Av 24 de maio, 355"); // Av 24 de maio, 355
    ...
    System.out.println(loc3.getEndereco() == "Aquidaban, 8350"); // Aquidaban, 8350
    ...
    System.out.println(cobrancaNovembro2020.getValorEstimado() == 3200.0); // 900+800+1500=3200

    // Paga as 3 locações
    cobrancaNovembro2020.pagar();

    System.out.println(cobrancaNovembro2020.getValorArrecadado() == 3200.0); // 900+800+1500=3200
