...
System.out.println("---> Exercício 01 --> Máquina D'Agua  <---");
...
//A máquina de água a seguir é idêntica a anterior, porém permite configurar
//sua capacidade e lança exceções para operações inválidas.
...
System.out.println(forno.ligado()); // false// os atributos temperatura e ligado devem ser inacessíveis (privados)
...
System.out.println("---> Exercício 04 --> EBook <---");
/*
...
EBook oOutroLadoDaIlha = new EBook("O Outro Lado da Ilha", 96);
System.out.println(oOutroLadoDaIlha.titulo.equals("O Outro Lado da Ilha"));
System.out.println(oOutroLadoDaIlha.paginaInicial == 1);

while (oOutroLadoDaIlha.lendoPagina != 96) {
  oOutroLadoDaIlha.virarPagina();
}
System.out.println(oOutroLadoDaIlha.lendoPagina == 96);

for (int i = 96; i > 1
 ; i--) oOutroLadoDaIlha.voltarPagina();

System.out.println(oOutroLadoDaIlha.lendoPagina == 1);

try {
  oOutroLadoDaIlha.irParaPagina(99);
  System.out.println(false);
} catch (IllegalArgumentException e) {
  System.out.println(true);
}
